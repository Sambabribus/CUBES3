...
<?php if (isset($_SESSION["user_isadmin"]) && $_SESSION["user_isadmin"]): ?>
    ...
    <body>
        ...
        <div class="container">
            ...
            <p>Bienvenue sur notre site de partage de recettes. Vous pouvez consulter les recettes partagées par les autres
                utilisateurs, ou bien partager vos propres recettes. Bon appétit !</p>
        </div>
