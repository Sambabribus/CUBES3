            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-8">
                <?php foreach ($recipes as $recipe): ?>
                    <div class="relative flex flex-col items-center border border-gray-200 rounded-lg min-h-64 max-h-96">
                        ...
                        <div class="absolute top-0 right-0 flex items-start gap-2.5">
                            <button id="<?php echo $toggleId ?>" data-dropdown-toggle="<?php echo $menuId ?>"
                                data-dropdown-placement="bottom-start"
                                class="inline-flex self-center items-center p-2 text-sm font-medium text-center text-gray-900 bg-transparent rounded-lg hover:bg-gray-100/50"
                                type="button">
                        ...
                        <div class="w-full flex flex-col gap-2">
                            <div class="w-full">
                                ...
                                <?php else: ?>
                                    <img class="w-full" src="https://placehold.co/180x120" alt="Placeholder" />
                                <?php endif; ?>
                            </div>
                            <div class="w-full flex flex-col gap-1 p-4">
                                <div>
                                    <p class="mb-3 text-gray-900 text-2xl font-bold leading-tight">
                                        <?php echo $recipe->getTitle() ?>
                                        <span class="text-gray-400 font-light text-sm"><?php echo $recipe->getServes() ?>.
                                            pers</span>
                                    </p>
                                </div>
                                <p class="mb-2 text-gray-700 font-normal"><?php echo $recipe->getDescription() ?></p>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
