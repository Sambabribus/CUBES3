            ...
            <div class="flex flex-col xl:flex-row min-h-[536px] gap-4">
                ...
                <div class="flex flex-col md:flex-row md:basis-2/3 border border-gray-300 rounded-t-lg xl:rounded-l-lg bg-white/40 xl:rounded-tr-none">
                    <div class="flex flex-col basis-3/5 p-4 divide-y divide-gray-200">
                        ...
                        <form method="post">
                            <div class="pb-2">
                                <label for="title" class="block mb-2 text-sm font-medium text-black">Titre</label>
                        ...
                        <!--#region Description -->
                            ...
                            <?php else: ?>
                                <p class="text-normal font-normal leading-tight pt-1">
                                    ...
                                    <br />
                                    <span class="whitespace-pre-wrap text-black"><?php echo $recipe->getDescription(); ?></span>
                                </p>
                            <?php endif; ?>
                            </div>
                            <!--#endregion -->
                ...
                <!--#endregion -->
                <!--#region Comments -->
                <div class="md:basis-1/3 border bg-white/40 border-gray-300 rounded-b-lg xl:rounded-r-lg xl:rounded-bl-none">
                    <div class="h-full p-2 flex flex-col gap-1">
                        <!--#region Post Comments -->
                        <?php if ($user_id > 0): ?>
                        <div class="justify-center grid">
                            <h1 class="text-3xl text-black font-semibold">Commentaires</h1>
                        </div>
                            ...
                            <div class="flex flex-row  w-full">
                                <form class="w-full flex flex-row" method="post">
                                    ...
                                    <button type="submit" name="btn_post_comments_recipe"
                                        class="h-16 text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 m-1 top-[calc(100%)] bg-[#A17C5E] transition-[background-color_0.3s_ease,_transform_0.2s_ease] focus:ring-brown-300 hover:scale-105 hover:bg-[#C49D83]">Poster</button>
                                </form>
                            </div>
                        </div>
                        <?php else: ?>
                        <div class="grid border border-gray-400 rounded-lg size-fit mx-auto">
                            <h1 class="text-xl text-black font-semibold text-center justify-self-center p-2">Connectez-vous pour
                        ...
                        <div class="flex flex-col gap-2 overflow-y-auto max-h-96">
                            <?php foreach ($getcomments as $comment) :
                                ...
                                <div class="flex flex-row border bg-white border-gray-200 rounded-lg p-4 divide-x gap-2">
                                    <img alt="Profile icon" src="data: image/svg+xml;base64,<?php echo base64_encode(
                                        file_get_contents(
                                            FileManager::rootDirectory() .
                                            "public/assets/icon/user.svg"
