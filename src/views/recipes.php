...
<body>
    ...
    <main class="container py-6 mx-auto">
        ...
        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2"><a href="ajout_recettes.php">Creer une recettes</a></button>
